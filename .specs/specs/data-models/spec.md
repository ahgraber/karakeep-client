...
- **Implementation**: `src/karakeep_client/models.py` — `KarakeepBaseModel`, `Bookmark`, `PaginatedBookmarks`, `ContentTypeLink`, `ContentTypeText`, `ContentTypeAsset`, `ContentTypeUnknown`, `BookmarkAsset`, `Asset`, `Tag`, `TagShort`, `Highlight`, `PaginatedHighlights`, `BookmarkList`
- **Dependencies**: none
